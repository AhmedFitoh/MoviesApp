...
class MoviesListPresenter {
    ...
    // MARK: - Life Cycle
    init(wireframe: MoviesListPresenterToWireframeProtocol, view: MoviesListPresenterToViewProtocol, interactor: MoviesListPresenterToInteractorProtocol, delegate: MoviesListDelegate? = nil) {
